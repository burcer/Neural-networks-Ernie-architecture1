...
from cs231n.layer_utils import affine_sigmoid_forward
from cs231n.layer_utils import affine_pwlsig2_backward
class ThreeLayerNet(object):
  ...
  def __init__(self, input_dim=3*32*32, hidden_dim1=256,hidden_dim2=256, num_classes=10,conv_size=256,
    ...
    if external_load==1:
      if levels==3:
        self.params['W1_1'] = np.load('W1_1ext784-256-10-3level.npy')
        self.params['W1_2'] =  np.load('W1_2ext784-256-10-3level.npy')
        self.params['W1_3'] =  np.load('W1_3ext784-256-10-3level.npy')
        self.params['W1_4'] =  np.load('W1_4ext784-256-10-3level.npy')

        self.params['b1_1'] =  np.load('b1_1ext784-256-10-3level.npy')
        self.params['b1_2'] = np.load('b1_2ext784-256-10-3level.npy')
        self.params['b1_3'] = np.load('b1_3ext784-256-10-3level.npy')
        self.params['b1_4'] = np.load('b1_4ext784-256-10-3level.npy')

      if levels==0:
        self.params['W1_1'] = np.load('W1_1ext784-256-10-cont.npy')
        self.params['W1_2'] =  np.load('W1_2ext784-256-10-cont.npy')
        self.params['W1_3'] =  np.load('W1_3ext784-256-10-cont.npy')
        self.params['W1_4'] =  np.load('W1_4ext784-256-10-cont.npy')

        self.params['b1_1'] =  np.load('b1_1ext784-256-10-cont.npy')
        self.params['b1_2'] = np.load('b1_2ext784-256-10-cont.npy')
        self.params['b1_3'] = np.load('b1_3ext784-256-10-cont.npy')
        self.params['b1_4'] = np.load('b1_4ext784-256-10-cont.npy')

      if levels==5:
        self.params['W1_1'] = np.load('W1_1ext784-256-10-5level.npy')
        self.params['W1_2'] =  np.load('W1_2ext784-256-10-5level.npy')
        self.params['W1_3'] =  np.load('W1_3ext784-256-10-5level.npy')
        self.params['W1_4'] =  np.load('W1_4ext784-256-10-5level.npy')

        self.params['b1_1'] =  np.load('b1_1ext784-256-10-5level.npy')
        self.params['b1_2'] = np.load('b1_2ext784-256-10-5level.npy')
        self.params['b1_3'] = np.load('b1_3ext784-256-10-5level.npy')
        self.params['b1_4'] = np.load('b1_4ext784-256-10-5level.npy')


      if levels==7:
        self.params['W1_1'] = np.load('W1_1ext784-256-10-7level.npy')
        self.params['W1_2'] =  np.load('W1_2ext784-256-10-7level.npy')
        self.params['W1_3'] =  np.load('W1_3ext784-256-10-7level.npy')
        self.params['W1_4'] =  np.load('W1_4ext784-256-10-7level.npy')

        self.params['b1_1'] =  np.load('b1_1ext784-256-10-7level.npy')
        self.params['b1_2'] = np.load('b1_2ext784-256-10-7level.npy')
        self.params['b1_3'] = np.load('b1_3ext784-256-10-7level.npy')
        self.params['b1_4'] = np.load('b1_4ext784-256-10-7level.npy')

      if levels==9:
        self.params['W1_1'] = np.load('W1_1ext784-256-10-9level.npy')
        self.params['W1_2'] =  np.load('W1_2ext784-256-10-9level.npy')
        self.params['W1_3'] =  np.load('W1_3ext784-256-10-9level.npy')
        self.params['W1_4'] =  np.load('W1_4ext784-256-10-9level.npy')

        self.params['b1_1'] =  np.load('b1_1ext784-256-10-9level.npy')
        self.params['b1_2'] = np.load('b1_2ext784-256-10-9level.npy')
        self.params['b1_3'] = np.load('b1_3ext784-256-10-9level.npy')
        self.params['b1_4'] = np.load('b1_4ext784-256-10-9level.npy')
  ...
  def loss(self, X, y=None,noise=0,noise2=0,test=0,parallel_samples_output=1):
    ...
    scores = None
    ############################################################################
    # Implements the forward pass for the two-layer net, computing the    #
...
##next layer:
    ...
    loss, grads = 0, {}
    ############################################################################
    # Implements the backward pass for the two-layer net. Store the loss  #
    ...
    reg = self.reg
    loss += 0.5 * reg * (np.sum(W1_1*W1_1) + np.sum(W2*W2)+np.sum(W1_2*W1_2)+np.sum(W1_3*W1_3)+np.sum(W1_4*W1_4) +np.sum(W3*W3) )
    dW1_1 += reg * W1_1
    dW1_2 += reg * W1_1
    dW1_3 += reg * W1_1
    dW1_4 += reg * W1_1
