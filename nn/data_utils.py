...
def get_CIFAR10_data(num_training=49000, num_validation=1000, num_test=1000, train_trinary=0, test_trinary=0, val_trinary=0, no_of_levels=256):
    """
